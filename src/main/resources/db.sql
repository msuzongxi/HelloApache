...
-- Started on 2024-09-04 18:10:30
...
DROP DATABASE ccdc;
--
-- TOC entry 3330 (class 1262 OID 16402)
-- Name: ccdc; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE ccdc WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'English_United States.1252';


ALTER DATABASE ccdc OWNER TO postgres;
...
-- Completed on 2024-09-04 18:10:30
